...
![alt text](images/deployment.png "Deployment parameters")
    ...
    1. We recomend creating a new resource group for each deployment or use an emty one.
    2. The deployment process may take up to 5 minutes.
    3. Make sure you pick region that has folowing models available for you
        modelName: 'gpt-35-turbo-16k' Version: '0613'
        modelName: 'text-embedding-ada-002' Version: '2'
    4. For Capacities we recomend using 30.  But each Azure Subscription has a unique limit.
    5. Web Service Authorization Key 1 and 2 should be unique values.  We recomend using random GUID generator like     https://guidgenerator.com/ to generate the values.
